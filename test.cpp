...
//    CashSolve cash{};
//
//    SolveBlockBP kek_solved = SolveBlockBP(copy_block.res_block, vec, cash);
//
...
//}
//
//void Test::diffForwardSimpleTest() {
//    std::shared_ptr<Variable> variable1 = std::make_shared<Variable>("x");
//    std::shared_ptr<Variable> variable2 = std::make_shared<Variable>("y");
//
//    std::shared_ptr<BlockBP> var1 = std::make_shared<BlockBP>(variable1);
//    std::shared_ptr<BlockBP> var2 = std::make_shared<BlockBP>(variable2);
//
//    std::shared_ptr<BlockBP> block1 = std::make_shared<BlockBP>(var1, var2, Operation::Mul);
//
//    std::shared_ptr<BlockBP> var3 = std::make_shared<BlockBP>(variable1);
//    std::shared_ptr<BlockBP> var4 = std::make_shared<BlockBP>(variable2);
//
//    std::shared_ptr<BlockBP> block2 = std::make_shared<BlockBP>(var3, var4, Operation::Mul);
//
//    std::shared_ptr<BlockBP> block3 = std::make_shared<BlockBP>(block1, block2, Operation::Minus);
//
//    std::vector<std::shared_ptr<Variable>> var_list { variable1, variable2 };
//
//    BackpropForward back = BackpropForward{block3, var_list};
//
//    back.main();
//    
//    if (back.block_tree.size() == 7) {
//        cout << "+ Test diffForwardSimpleTest() Complited!" << endl;
//    } else {
//        cout << "- Test diffForwardSimpleTest() Failed!" << endl;
//    }
//}
//
//void Test::diffForwardRecTest() {
//
//    std::shared_ptr<Variable> variable1 = std::make_shared<Variable>("x");
//    std::shared_ptr<Variable> variable2 = std::make_shared<Variable>("y");
//
...
//    auto time1 = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);
//
//    std::cout << "Time Forward: " << time1.count() << endl;
//
//    auto begin2 = std::chrono::steady_clock::now();
//
//    BackpropRec back2 = BackpropRec{ block3, var_list };
//
//    auto end2 = std::chrono::steady_clock::now();
//    auto time2 = std::chrono::duration_cast<std::chrono::microseconds>(end2 - begin2);
//
//    std::cout << "Time Rec: " << time2.count() << endl;
//}
//
//
//
...
//
//    SolveBlockBP solved = SolveBlockBP(copy_block.res_block, vec, cash);
//
...
//    cout << "test go" << endl;
//    Perseptron perseptron = Perseptron(1, 1, 5, 0.0001);
...
//}
//
//void Test::perseptron2Test() {
//    cout << "test go" << endl;
//    Perceptron2 perseptron = Perceptron2(1, 1, 5, 5, 0.0001);
//    auto exit_variables = perseptron.exit_variables;
//    auto input_variables = perseptron.input_variables;
//
//    for (int q1 = 0; q1 < 10; q1++) {
//        for (int q = 0; q < 10; q++) {
//            std::cout << "q1 : " << q1 << " ; q : " << q <<std::endl;
//            std::cout << "IN : " << q << std::endl;
//            std::cout << "ANSWER : " << parabola(q) << std::endl;
//            std::vector<std::pair<std::shared_ptr<Variable>, double>> test_var_value = {};
//            test_var_value.push_back(std::make_pair(exit_variables[0], parabola(q)));
//            std::vector<std::pair<std::shared_ptr<Variable>, double>> input_var_value = {};
//            input_var_value.push_back(std::make_pair(input_variables[0], q));
